			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="myModalLabel">このサイトについて</h5>
					</div>
					<div class="modal-body">
						<label>当サイトはBA-SHOWとR.Aoiによる参考作品のため、商品の販売は致しておりません。<br>詳しくは「当サイトについて」をご覧ください。</label>
					</div>
		...
		<div class="container my-5">
			...
			<div class="row">
				...
				<div class="col-6 col-md-4 col-lg-3 mb-4">
					<div class="card">
						<img src="{{ $product->product_image }}" alt="商品画像" class="card-img-top">
						<div class="card-body">
							<p class="card-title">{{ $product->product_name }}</p>
							<p class="card-text">{{ $product->price }} 円</p>
							<p class="card-text text-right"><a href="{{ route('product.show', $product->id) }}">> 詳細を見る</a></p>
						</div>
					</div>
				</div>
				@endforeach
			...
			<div class="row my-4">
				<div class="col">
					...
					<p class="text-center text-white">2019 (c) BA-SHOW and R.Aoi<br>
						Do not use the images in this website.</p>
				</div>
			</div>
		</div>
	</footer>
